...
_REWARD_DESCRIPTIONS = {
    "R_STEP": "Tính điểm với mỗi action",
    "collision": "Tính điểm với hành động Forward va chạm tường",
    "forward_clear": "Tính điểm với hành động Forward không va chạm tường",
    "wall_detected": "Tính điểm với hành động phát hiện ra tường lần đầu tiên (state của robot phần tường chuyển từ 0 sang 1)",
    "wall_visible": "Tính điểm với hành động Rotate mà phát hiện tường",
    "wall_on_entry": "Tính điểm nếu vào ô có tường (đã biết trước hoặc Forward phát hiện), 1 lần vào ô chỉ tính một lần",
    "goal_closer": "Tính điểm khi \"Trend goal\" của action vừa làm là +1",
    "goal_farther": "Tính điểm khi \"Trend goal\" của action vừa làm là -1",
    "goal_reached": "Tính điểm khi action chạm vào ô Goal",
    "cp_closer": "Tính điểm khi \"Trend CP\" của action vừa làm là +1",
    "cp_farther": "Tính điểm khi \"Trend CP\" của action vừa làm là -1",
    "checkpoint": "Tính điểm khi action chạm vào ô Checkpoint",
    "rotate": "Tính điểm khi xoay tại chỗ",
    ...
    "ping_pong": "Tính điểm khi đi qua đi lại liên tục",
    "straight_streak_reach": "Tính điểm khi giữ một hướng qua n lần",
    "straight_streak_cap": "Tính điểm trong n lần giữ hướng, qua n lần thì không tính điểm nữa",
}
