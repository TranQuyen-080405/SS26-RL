...
def run():
    from modules.logics.robot_map import init_robot_map, apply_walls_from_spec    from modules.logics.robot_state import make_robot, inject_distances_from_map, is_at_goal
    ...
    _log("Het episode — cho Start infer de chay lai")
    try:
        publish_idle()
    except Exception:
        pass
