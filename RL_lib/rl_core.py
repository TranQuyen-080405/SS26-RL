"""
RL thuần hàm — encode state, dist_trend, get_policy (PC / Simulation).
Bản MicroPython: copy/sync sang Robot_embbed/modules/logics/rl_core.py
"""

from RL_lib.grid import DIRECTIONS
...
def obstacle_bits(obstacle_nwes):
    """obstacle_nwes: (N, W, E, S) mỗi phần tử 0 hoặc 1."""
